...
import { useUser, logOutUser } from "../../context/UserContext";
...
function Sidebar() {
  ...
  return (
    ...
    <div className="sidebar no-print">
      ...
      {(user?.accountType === "Admin" || user?.accountType === "Affiliate") && (
        <>
          <SidebarRow
            path="/app/vendors"
            Icon={GroupsIcon}
      ...
      {(user?.accountType === "Affiliate" || user?.accountType === "Admin") && (
        <SidebarRow
          path="/app/affilates"
          Icon={HubIcon}
      ...
      {(user?.accountType === "Stockiest" || user?.accountType === "Admin") && (
        <SidebarRow
          path="/app"

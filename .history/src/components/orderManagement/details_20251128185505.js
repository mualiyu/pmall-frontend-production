        ...
        <section className=" w-full" style={{display:"block"}}>
            ...
            style={{marginTop: 4, textTransform: 'capitalize'}}>
              ...
              {user?.accountType === 'Vendor' && (
                <>
                  <option value="push-to-stovkist">Push to Stockist</option>
                  <option value="deliver-to-stovkist">Deliver to Stockist</option>
                </>
              )}
              {user?.accountType === 'Stockist' && (
                 <>
                  <option value="push-to-stovkist">Out for Delivery</option>
                  <option value="push-to-stovkist">Received From Vendor</option>
                  <option value="push-to-stovkist">Packaging</option>
                  <option value="push-to-stovkist">Returned</option>
                  <option value="push-to-stovkist">Cancelled</option>
                  <option value="push-to-stovkist">Confirmed</option>
                  <option value="push-to-stovkist">Delivered</option>
                </>
              )}

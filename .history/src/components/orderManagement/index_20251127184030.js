...
const columns = [
  ...
  { id: "delivery_status", label: "DeliveryStatus" },
            ...
            <Table
              ...
              { allOrders?.map((order, i) => (
                <TableRow key={order?.id}>
                  ...
                  <TableCell><span className="badge bg-success">{order?.payment_status}</span>{" "}
                  <TableCell><span className="badge bg-error">{order.status}</span>{" "}
                  </TableCell>

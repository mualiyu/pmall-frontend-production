          ...
          <TableContainer component={Paper}>
            <Table
              ...
              { allOrders
                ...
                <TableRow key={order?.id} style={{textTransform: 'capitalize'}}>
                  ...
                  <TableCell > 
                  <button  onClick={() => handleViewOrder(order)}  class="btn btn-primary p-25">
                    View Details
                  </button>
                  {user?.accountType === 'Stockist' && (
                 <>
            ...
            style={{marginTop: 4, textTransform: 'capitalize'}}>
               <option>Manage Order</option>
                  ...
                  <option value="Out For D">Out for Delivery</option>
                  <option value="Out For D">Received From Vendor</option>
                  <option value="Out For D">Packaging</option>
                  <option value="Out For D">Returned</option>
                  <option value="Out For D">Cancelled</option>
                  <option value="Out For D">Confirmed</option>
                  <option value="Out For D">Delivered</option>

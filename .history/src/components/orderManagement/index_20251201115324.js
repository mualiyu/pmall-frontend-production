          ...
          <TableContainer component={Paper}>
            ...
            style={{marginTop: 4, textTransform: 'capitalize'}}>
               <option>Manage Order</option>
                  ...
                  <option value="Out For Delivery">Received From Vendor</option>
                  <option value="Out For Delivery">Packaging</option>
                  <option value="Out For Delivery">Returned</option>
                  <option value="Out For Delivery">Cancelled</option>
                  <option value="Out For Delivery">Confirmed</option>

      ...
      <Modal
        ...
        <Box sx={style}>
          ...
          <section className="flex__normal">
            ...
            <form style={{ width: "100%" }}>
              <section className="flex-container mb-lg">
                ...
                <div className="pos-rel w100-m10 ">
                  ...
                  <select
                    ...
                    value={selectedProduct.name || inputValues.category_id || ""}
                    name="category_id"
              ...
              <section className="flex-container mb-lg">
                <div className="pos-rel w100-m10 ">
                  ...
                  <select
                    className="search__bar w-100"
                    name="brand_id"
                    value={selectedProduct.name || inputValues.brand_id || ""}
                    onChange={onChangeHandler}
                    >
                ...
                <div className="pos-rel w100-m10 ">
                  ...
                  <input
                    ...
                    placeholder="1500"
                    onChange={onChangeHandler}
                    value={selectedProduct.name || inputValues.cost_price || ""}
                  />
                </div>
                <div className="pos-rel w100-m10 ">
                  ...
                  <input
                    ...
                    placeholder="1200"
                    onChange={onChangeHandler}
                    value={selectedProduct.name || inputValues.selling_price || ""}
                  />
                </div>
              </section>
              <section className="flex-container mb-lg">
              <div className="pos-rel w100-m10 ">
                  ...
                  name="inStock"
                    ...
                    // name="category_id"
                    onChange={onChangeHandler}
                    value={selectedProduct.name || inputValues.inStock || ""}
                    >
                ...
                <div className="pos-rel w100-m10 ">
                  ...
                  <input
                    ...
                    placeholder="500"
                    onChange={onChangeHandler}
                    value={selectedProduct.name || inputValues.quantity || ""}
                  />
                </div>
              </section>
              <section className="flex-container mb-lg">
            ...
            id="tags-outlined"
            options={[]}
            value={selectedProduct.tag || inputValues.tags}

...
const ProductList = () => {
  ...
  const { user } = useUser();
  const {inputValues, setState, onChangeHandler,loading, setLoading,  visible, setVisible,} = useVendor();
...
const [isEditMode, setIsEditMode] = useState(false);
  ...
  const tagsValue = Array.isArray(inputValues.tags) ? inputValues.tags : [];
...
/>
  ...
  freeSolo
  options={[]}
  value={Array.isArray(inputValues.tags) ? inputValues.tags : []}

            ...
            <TableBody>
              {categories && categories.map((category, index) => (                   
                ...
                <TableCell className="b-r">
                  <div className="d-flex alc f-10 flex-start">
                      <img src={category.category_image} alt="" className="w50" alt={category?.name}/>
                  </div>
                </TableCell>
                <TableCell>
          ...
          <Table sx={{ minWidth: 650 }} size="small" aria-label="Porduct Table">
            ...
            <TableBody>
              {brands && brands.map((brand, index) => (                   
                ...
                <TableCell className="b-r">
                  <div className="d-flex alc f-10 flex-start">
                    <img src={brand.brand_image} alt="" className="w50" alt={brand?.name}/>
                  </div>
                </TableCell>
                <TableCell>
        ...
        <Box sx={style}>
          ...
          <section className="flex__normal">
            <div className="w-250">
              <div className="">
                {inputValues.image ?
                 <img src={inputValues.image} className="w-100i" name="image" alt="Image" value={inputValues.image || ""} /> :
                <img src={profile} className="w-100i" name="image" value={inputValues.image || ""}  alt="User Profile"/>
                }
      ...
      <Modal
        ...
        <Box sx={style}>
          ...
          <section className="flex__normal">
            <div className="w-200">
              <div className="">
                <img src={profile} className="w-100i" name="image" value={inputValues.image|| ""} alt="Product Image" />
                <div className="pos-rel w100-m10 ">
                  <input
                    type="file"
                    className="form-control-input no-border"
      ...
      <Modal
        ...
        <Box sx={style}>
          ...
          <section className="flex__normal">
            <div className="w-200">
              <div className="">
                <img src={profile} className="profile_pic" name="image" value={inputValues.image|| ""} alt="Category Image" />
                <div className="pos-rel w100-m10 ">
                  <input
                    type="file"
                    className="form-control-input no-border"
...
<Modal
        ...
        onClose={handleRejectedProductModalClose}
        onClose={(event, reason) => {
          if (reason === 'backdropClick') return;
      ...
      <Modal
        ...
        <Box sx={style}>
          ...
          <section className="flex__normal">
            <div className="w-200">
              <div className="">
                <img src={inputValues.category_image} className="profile_pic" name="image" value={inputValues.image|| ""} alt="Category Image" />
                <div className="pos-rel w100-m10 ">
                  <input
                    type="file"
                    className="form-control-input no-border"
      ...
      <Modal
        ...
        <Box sx={style}>
          ...
          <section className="flex__normal">
            <div className="w-200">
              <div className="">
                <img src={profile} className="profile_pic" name="image" value={inputValues.image|| ""} alt="Sub Category Image" />
                <div className="pos-rel w100-m10 ">
      ...
      <Modal
        ...
        <Box sx={style}>
          ...
          <section className="flex__normal">
            <div className="w-200">
              <div className="">
                <img src={profile} className="w-100i" name="image" value={inputValues.image|| ""} alt="Brand Image"/>
                <div className="pos-rel w100-m10 ">
                  <input
                    type="file"
                    className="form-control-input no-border"
      ...
      <Modal
        ...
        <Box sx={style}>
          ...
          <section className="flex__normal">
            <div className="w-200">
              <div className="">
                <img src={inputValues?.brand_image} className="w-100i" name="image" value={inputValues.image|| ""} alt="Brand Image" />
                <div className="pos-rel w100-m10 ">
                  <input
                    type="file"
                    className="form-control-input no-border"

...
const [isEditMode, setIsEditMode] = useState(false);
  ...
  const handleProductLiveStatus = async (product, e) => {
    ...
    console.log("Selected Product:", selectedStatus);
...
// 0 = Pending/No Action    1 = Accept/Publish   2 = Decline/Reject    3 = Send For Approval
    ...
    let verb = selectedStatus == "1" ? "products/update-status/admin" : selectedStatus == "2" ? "" : selectedStatus == "3" ? "products/sendforapproval" : "";
    ...
    try {
      ...
      if(result.status) {
        ...
        setProductLiveState("");
        setTimeout(() => setToast(null), 5000);
    console.log("Error Upating Product:", result);
      }
    } catch (error) {

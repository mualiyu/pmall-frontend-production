              ...
              {products?.map((product, index) => (                   
                <TableRow key={product?.id} className="capitalize">
                  ...
                  <TableCell onClick={() => navigate(`/app/products/details/${product?.id}`)}>
                    ...
                    {/* 0 = Pending/No Action    1 = Accept/Publish   2 = Decline/Reject    3 = Send For Approval */}
                    {product?.status === '0' ?
                    <span className="badge b">Pending</span>
                    : product?.status === '1' ? <span className="badge">Published</span> :
                    product?.status === '2' ? <span className="badge">Rejected</span> :
                    <span className="badge">Sent For Approval</span>
                    }
                  </TableCell>
                  <TableCell  
                  onClick={() => {

              ...
              {products?.map((product, index) => (                   
                <TableRow key={product?.id} className="capitalize">
                  ...
                  <TableCell onClick={() => navigate(`/app/products/details/${product?.id}`)}>
                    ...
                    : product?.status === '1' ? <span className="badge c-green">Published</span> :
                    product?.status === '2' ? <span className="badge c-red">Rejected</span> :
                    <span className="badge info">Sent For Approval</span>
                    }
                  </TableCell>
                  <TableCell  
                  onClick={() => {

    ...
    fetch(`${BASE_URL}/profile`, {
      ...
      .then((result) => {
        ...
        setState({
          ...
          wallet: result.data.user.wallet.amount,
          pmt: result.data.user.wallet.pmt,
          pv: result.data.user.wallet.pv,
  ...
  return (
    <section className="w-full" style={{ display: "block" }}>
      ...
      <div className="user-details">
        ...
        <div className="flex-container flex-col w-full p-y my-40 g-20" style={{margin-top: 10%;>
          <div>
            <button

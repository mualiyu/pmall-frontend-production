...
const Users = () => {
  ...
  const userTypes = (arr) => {
    ...
    data.datasets[0].data = [admins.length, vendors.length, affiliates.length];
  };
      ...
      <section className="page__header">
        ...
        <div className="">
          <button
            ...
            {user.accountType === "Admin" ? "Create Admin" : "Add Vendor Staff"}
          </button>
        </div>
      </section>
      ...
      <section className="stat m-10">
        ...
        <div className="right__stat">
          <div className="right__sub s-divider">
            <h3 className="stat__value c-success">{affiliates.length}</h3>
            <p className="sub__title">Affiliates</p>
          </div>
          <div className="right__sub flex">
            <div>
        ...
        <Box sx={{ width: "100%" }}>
          <Box sx={{ borderBottom: 1, borderColor: "divider" }}>
            <Tabs
              ...
              <Tab
                label={`System Users (${pmallUsers.length})`}
                {...a11yProps(0)}
              />

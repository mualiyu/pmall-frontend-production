...
const VendorStore = () => {
    ...
    const getVendorProducts = async () => {
        ...
        try {
          const response = await fetch(`${BASE_URL}/products/list-all-by-vendor?store_id=${storeId}`, {
            http://pmall-backend.test/api/v1/public/products/list-all-by-vendor?store_id=PMS-182950
            method: "GET",
            headers: {

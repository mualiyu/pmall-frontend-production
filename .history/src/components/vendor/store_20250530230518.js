...
const VendorStore = () => {
    ...
    const refLink = query.get('storeId');


    const getVendorProducts = async () => {
        console.log('hey', refLink);
        setLoading(true);
        try {/public/products/list-all-by-vendor?store_id=
          const response = await fetch(`${BASE_URL}/public/products/list-all-by-vendor?store_id=${refLink}`, {
            method: "GET",
            headers: {

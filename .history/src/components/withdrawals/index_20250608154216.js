...
const WithdrawalHistory = () => {
  ...
  const { user } = useUser();
  const [balanceInsufficient, setBalanceInsufficient]
...
const validateWallet = () => {
  ...
  if(inputValues.amount > parseInt(user.wallet)) {
              ...
              <div className="pos-rel w100-m10 ">
                ...
                <div className="pos-rel w100-m10 ">
                  ...
                  <input
                    ...
                    name="amount"
                    placeholder="500"
                    onKeyUp={validateWallet}
                    onChange={onChangeHandler}
                    value={inputValues.amount || ""}
                  />
                  <p className="insufficient">Insufficient Fund</p>
                </div>
              </section>

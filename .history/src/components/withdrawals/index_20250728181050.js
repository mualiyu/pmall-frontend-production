        ...
        <div className="flex-container alc">
          ...
          <div>
            <h3>Withdrawal History 
              <span className="badge error">{withdrawals?.length === 0 ? '0'  }</span>
              </h3> 
          ...
          <TableRow key={trx.id}>
              ...
              <TableCell className="b-r">
                <div className="d-flex alc f-10 flex-start">
                  <div className="lheight13">
                    <h4 className="">{moment(trx.created_at).format("lll")} </h4>
                  </div>
                </div>
              </TableCell>
              <TableCell className="b-r">
              ...
              <div className="d-flex alc f-10 flex-start">
                  <div className="lheight13">
                      ...
                      <p class="sub__title">({trx?.user.user_type} -  <PackageName id={trx?.user?.package_id } type={trx?.user.user_type} />)</p>
                    </div>
              </div>
              </TableCell>
              <TableCell> 
              ...
              <div className="d-flex alc f-10 flex-start">
                  <div className="lheight13">
                      <h4 class="f-300">{ trx.user.phone }  </h4>
                      <p class="sub__title">{ trx.user.email } </p>
                    </div>
              </div>
              </TableCell>
              <TableCell> 

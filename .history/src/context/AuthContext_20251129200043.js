      ...
      .then((result) => {
        ...
        if (result.status) {
          ...
          setUser({
            ...
            token: result.token,
            address: result.customer.user_type,
            loggedIn: true,
            country: result.stockist.country,
            city: result.stockist.city,
            regDate: result.customer.created_at,
            refId: result.stockist.affiliate_id,
          });
          // );

          // "status": true,
    // "message": "Login successful",
    // "token": "582|go8FqodxUX7ok9B5SyNHXVluuM5qkfUkAzRZEFOYd30163d4",
    // "stockist": {
    //     "id": 13,
    //     "name": "Aghedo Test 2",
    //     "affiliate_id": "PM-568356",
    //     "email": "unseenpromise123@gmail.com",
    //     "phone": "090123456789",
    //     "address": "Promise Store",
    //     "country": "Nigeria",
    //     "state": "Abuja",
    //     "is_active": "1",
    //     "created_at": "2025-11-25T10:09:49.000000Z",
    //     "updated_at": "2025-11-25T10:09:49.000000Z",
    //     "city": "test Municipal"
    // }
          setToastMsg("Boom! Login successful");
          setToastType("success");

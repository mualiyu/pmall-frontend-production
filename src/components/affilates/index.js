...
function createData(affilate, rank, email, referrals, amt_generated,registered, status, action) {
  return { affilate, rank, email, referrals, amt_generated,registered, status, action };
}
  ...
  return (
    <section>
      ...
      <section className="flex-container alc p-y my-40">
        ...
        <div className="">
          <button className="btn btn-primary p-25" onClick={() => setNewVendorModal(true)}>Add Affilate</button>
        </div>
      </section>

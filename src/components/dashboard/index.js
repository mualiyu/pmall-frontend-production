    ...
    <section className="dashboard">
      ...
      <div>
          <ul className="flex-container g-20 sub__title">
              <li className="active pointer" onClick={dashboard}>Dashboard</li>
              <li className="pointer" onClick={affilate}>Affilate</li>
              <li className="pointer" onClick={vendor}>Vendor</li>
              <li className="pointer" onClick={product}>Product</li>
          </ul>
      </div>
      <h3 className="pointer"  onClick={() => setNewVendorModal(true)}>Manage</h3>
        </div>
      </section>
      {dashboardTab &&
      <div className="flex g-10 justsb">
              ...
              <div className="flex g-10">
                  <div className="balance available">
                    ...
                    <span className="balance-text">
                        ...
                        <h1 className="flex">$14,823.20 <span className="balance-percentage"><ArrowUpwardOutlinedIcon style={{fontSize:"8px",marginRight:2}}/> <p>8.0%</p> </span></h1>
                    </span>  
                  ...
                  <div className="balance pending">
                    <span className="balance-icon-container">
                      ...
                      <span className="balance-text">
                        ...
                        <h1 className="flex">$2,498.80  <span className="balance-percentage"><ArrowDownwardOutlinedIcon style={{fontSize:"8px",marginRight:2}}/><p>2.0%</p></span></h1>
                      </span>
                  </div>
              </div>
          </section> 
            <div style={{width:'100%',maxHeight:'100%'}} className="dashboard-chart gap-10 g-20">
        ...
        <div className="g-20 flex-col">
            ...
            <div className="card">
              ...
              <span className="flex">
                  ...
                  <select defaultValue={'default'}>
                    ...
                    <option value="Parent 2"> Card 8345 **** **** ****</option>
                    <option value="Parent 3"> Card 4369 **** **** ****</option>
                  </select>
              </span>
              </div>
          ...
          <div className="recent-vendors">
            <h1 style={{marginBottom:20,textTransform:"uppercase"}}>Recently registerd vendors</h1>
            <div className="gap-10">
              ...
              <div className="flex">
                ...
                <div>
                    <h4 className="f-300">Dennis Abdulmalik (Dennis fitness)</h4>
          ...
          <div className="recent-affilates">
            <h1 style={{marginBottom:20,textTransform:"uppercase"}}>Recently registerd affilates</h1>
            <div className="gap-10">
              <div className="flex">
                <div className="user__avatar bg-success">
                  <h3>AP</h3>

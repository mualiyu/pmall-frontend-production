...
const columns = [
<<<<<<< HEAD
<<<<<<<< HEAD:src/components/products/index.js
...
>>>>>>>> 1397e171941f92415d26531c7a23f38533de46a2:src/components/productList/index.js
...
<<<<<<<< HEAD:src/components/products/index.js
function createData(product_image, name, brand, selling_price, created_at, status, action) {
  return {product_image, name, brand, selling_price, created_at, status, action };
}
  ...
  return (
    <section>
      ...
      <section className="flex-container alc p-y my-40">
        ...
        <div className="">
<<<<<<<< HEAD:src/components/products/index.js
          <button className="btn btn-primary p-25" onClick={() => setNewProductModal(true)}>Add product</button>
========

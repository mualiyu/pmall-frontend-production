...
const Users = () => {
  ...
  const getAssistants = () => {
    fetch("https://api.pmall.mukeey.com.ng/api/v1/get-all-vendors", {
      method: "GET",
      headers: {
        "Content-Type": "application/json;charset=UTF-8",
        Accept: "application/json",
  ...
  const addVendorAssistant = (e) => {
    e.preventDefault();
    setLoading(true);
    fetch("https://api.pmall.mukeey.com.ng/api/v1/user/add-vendor", {
      method: "POST",
      headers: {
        "Content-Type": "application/json;charset=UTF-8",
        Accept: "application/json",
  ...
  const addAdmin = (e) => {
    e.preventDefault();
    setLoading(true);
    fetch("https://api.pmall.mukeey.com.ng/api/v1/admin/register", {
      method: "POST",
      headers: {
        "Content-Type": "application/json;charset=UTF-8",
        Accept: "application/json",

    ...
    <section className="vendor-details">
      <section className="page__header">
        <div className="flex-container alc">
            <h3 style={{fontSize: "15px"}}><span style={{color: "#8c8c8cd6",fontSize: "15px"}}>Vendors /</span> Zain Ahmad</h3>
        </div>
        <div className="flex g-20 all-center">
          <span className="calender flex all-center">
            ...
            <h3 className="capitalize pointer flex all-center black"><ListAltOutlinedIcon />VIEW STATEMENT</h3>
            <p  style={{color: "#8c8c8cd6"}}>|</p>
            <h3 className="capitalize pointer flex all-center black">< CreateOutlinedIcon />EDIT CUSTOMER DETAILS</h3>
        </div>
      </section>
      <section>
          <div className="flex main-stats" style={{gap:"80px"}}>
            <div className="flex-col g-20">
                <h3 className="g-5">Total Estimates <span className="stat-digits">6</span></h3>
            ...
            <div  className="flex-col g-20">
                <h3>All Orders <span className="stat-digits">2</span></h3>
                <div className="flex g-20">
                    <div className="flex-col g-5">
                        <h3>#34.2k</h3>
            ...
            <div  className="flex-col g-20">
                <h3>Invoices <span className="stat-digits">6</span></h3>
                <div className="flex g-20">
                    <div className="flex-col g-5">
                        <h3>#34.2k</h3>
                        <p className="capitalize stat-p green"><TripOriginRoundedIcon/> PAID (1)</p>
                    </div>
                    <div className="flex-col g-5">
                        <h3>#10.8k</h3>
                        <p className="capitalize stat-p yellow"><TripOriginRoundedIcon/> PENDING (1)</p>
                    ...
                    <div className="flex-col g-5">
                        <h3>#1.89k</h3>
                        <p className="capitalize stat-p red"><TripOriginRoundedIcon/> OVERDUE (3)</p>
                    </div>
                    <div className="flex-col g-5">
                        <h3>#34.2k</h3>
                        <p className="capitalize stat-p"><TripOriginRoundedIcon/> DRAFT (1)</p>
                    </div>
                </div>
            </div>
          </div>

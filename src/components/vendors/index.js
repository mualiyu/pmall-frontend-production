  ...
  return (
    <section>
      ...
      <section className="flex-container alc p-y my-40">
        ...
        <div className="">
          <button className="btn btn-primary p-25" onClick={() => setNewVendorModal(true)}>Add Vendor</button>
        </div>
      </section>
            ...
            <form style={{width: '100%'}} >
              ...
              <section className="flex-container mb-lg">
                    ...
                    <label className="mb-7">  Address</label>
                        <textarea placeholder="Enter store address" className="form-textarea w-100"></textarea>
                    </div>
